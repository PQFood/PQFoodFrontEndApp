...
import AdminUseGetFood from '../hooks/AdminUseGetFood';

function AdminEditFoodMenu(props) {
    ...
    useEffect(() => {
        AdminUseGetFood({ setLoading, setFood, slug, setImage })
    }, [])
    ...
    if (loading) {
        ...
        return (
            <ScrollView>
                <Text style={styles.textHeader}>Cập nhật thực đơn</Text>
                <Formik
                    enableReinitialize={false}
                    initialValues={{
                        nameFood: food.name,
                        price: food.price,
                        classify: food.classify.toString(),
...
export default AdminEditFoodMenu;